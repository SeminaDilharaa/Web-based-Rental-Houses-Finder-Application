...
<form action="" method="post" enctype="multipart/form-data"><!-- form Begin -->
	...
	<div class="form-group"><!-- form-group Begin -->
		<label> Customer Distric: </label>
		<input type="text" name="c_distric" class="form-control" required>
	</div><!-- form-group Finish -->
	...
	<div class="form-group"><!-- form-group Begin -->
		...
		<img class="img-responsive" src="customer_images/profile.jpg" alt="Customer Image">
	</div><!-- form-group Finish -->
