    ...
    ?>
   		...
   		<div class="col-md-9"><!-- col-md-9 Begin -->
   			<div class="box"><!-- box Begin -->
   				<h1>House</h1>
   				<p>behavioral design is probably more often referrred to as usability, but the 2 terma essentially refer to the practical and functional aspects of a product or anything usable, we are capable of using in our environment.</p>
   			</div><!-- box Finish -->
                ...
                <a href="details.php" class="btn btn-primary">
                  <i class="fa fa-shopping-cart">
   				...
   				<div class="col-md-4 col-sm-6 center-responsive"><!-- col-md-4 col-sm-6 center-responsive Begin -->
   					...
   					<div class="product"><!-- Product Begin -->
            <a href="details.php">
              <img class="img-responsive" src="admin_area/product_images/images 4.jpg" alt="images 4">
            </a>
                ...
                <a href="details.php" class="btn btn-primary">
                  <i class="fa fa-shopping-cart">
   				...
   				<div class="col-md-4 col-sm-6 center-responsive"><!-- col-md-4 col-sm-6 center-responsive Begin -->
   					...
   					<div class="product"><!-- Product Begin -->
            <a href="details.php">
              <img class="img-responsive" src="admin_area/product_images/images 5.jpg" alt="images 5">
            </a>
                ...
                <a href="details.php" class="btn btn-primary">
                  <i class="fa fa-shopping-cart">
   				...
   				<div class="col-md-4 col-sm-6 center-responsive"><!-- col-md-4 col-sm-6 center-responsive Begin -->
   					...
   					<div class="product"><!-- Product Begin -->
            <a href="details.php">
              <img class="img-responsive" src="admin_area/product_images/images 6.jpg" alt="images 6">
            </a>
