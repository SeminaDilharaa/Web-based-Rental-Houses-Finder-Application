              ...
              <div id="myCarousel" class="carousel slide" data-ride="carousel"><!-- carousel slide Begin -->
                ...
                <div class="carousel-inner"><!-- carousel-inner Begin -->
                  <div class="item active"><!-- item active Begin -->
                   <center><img class="img-responsive" src="admin_area/product_images/images 4.jpg" alt="images 4"></center>
                  </div><!-- item active Finish -->

                  <div class="item"><!-- item Begin -->
                   <center><img class="img-responsive" src="admin_area/product_images/images 5.jpg" alt="images 5"></center>
                  </div><!-- item Finish -->

                  <div class="item"><!-- item Begin -->
                   <center><img class="img-responsive" src="admin_area/product_images/images 6.jpg" alt="images 6"></center>
                  </div><!-- item Finish -->
              ...
              <div class="row" id="thumbs"><!-- row Begin -->
                ...
                <div class="col-xs-4"><!-- col-xs-4 Begin -->
                  <a data-target="#myCarousel" data-slide-to="0" href="#" class="thumb"><!-- thumb Begin -->
                    <img src="admin_area/product_images/images 4.jpg" alt="images 4" class="img-responsive">
                  </a><!-- thumb Finish -->
                </div><!-- col-xs-4 Finish -->
                  ...
                  <a data-target="#myCarousel" data-slide-to="1" href="#" class="thumb"><!-- thumb Begin -->
                    <img src="admin_area/product_images/images 5.jpg" alt="images 5" class="img-responsive">
                  </a><!-- thumb Finish -->
                </div><!-- col-xs-4 Finish -->
                  ...
                  <a data-target="#myCarousel" data-slide-to="2" href="#" class="thumb"><!-- thumb Begin -->
                    <img src="admin_area/product_images/images 6.jpg" alt="images 6" class="img-responsive">
                  </a><!-- thumb Finish -->
                </div><!-- col-xs-4 Finish -->
