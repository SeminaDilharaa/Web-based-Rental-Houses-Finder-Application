...
<body>
   ...
   <div id="content"><!-- #content Begin -->
   	<div class="container"><!-- container Begin -->
   		...
   		<div class="col-md-3"><!-- container Finish -->
          ...
          <div class="box-header"><!-- box-header Begin -->
            <center><!-- Center Finish -->
              ...
              <p class="text-muted"><!-- text-muted Begin -->
                If you have questions, feel free to contact us. Our Customer Service work <strong> 24/7</strong>
              </p><!-- text-muted Finish -->
            </center><!-- Center Finish -->


            <form action="customer_register" method="post" enctype="multipart/form-data"><!-- Form Begin -->
              ...
              <div class="form-group"><!-- form-group Begin -->
                <label>Type</label>
                <select id="disabledSelect" class="form-control" name="c_type" required="">
               ...
               <div class="form-group"><!-- form-group Begin -->
                <label>Your Distric</label>
                <input type="text" class="form-control" name="c_distric" required="">
              </div><!-- form-group Finish -->


               <div class="form-group"><!-- form-group Begin -->
                <label>Your City</label>
                <input type="text" class="form-control" name="c_citys" required="">
              </div><!-- form-group Finish -->
